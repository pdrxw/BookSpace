...
public class HistoricoEmprestimoController {
    ...
    public String listarHistoricoEmprestimos(
        ...
        if (search != null && !search.trim().isEmpty()) {
            // Se houver valor em 'search', busca históricos por multiplos campos
            historicos = historicoEmprestimoService.buscarHistoricoPorCampos(search, orderBy);
        } else {
            // Caso contrário, apenas lista os históricos com a ordenacao
        ...
        return "historico-emprestimos"; // Pagina de lista de histórico de emprestimos
    }
